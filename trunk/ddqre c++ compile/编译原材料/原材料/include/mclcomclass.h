...
public:
	...
	virtual HRESULT __stdcall CreateInstance(IUnknown *pUnknownOuter, REFIID iid, void** ppv)
	{
		...
		if (!mclComCheckMWComUtil())
		{
			...
			errmsg.append(" could not be found in the registry. Please refer to MATLAB Builder for .Net or Excel documentation on how to install and register MWComUtil.");
